...
const LoginForm: React.FC<LoginProps> = ({ title, buttonText }) => {
      ...
      <Row>
        <Col lg={{ span: 6, offset: 3 }} md={{ span: 8, offset: 2 }}>
          <BlueBackground>
            ...
            <Button type="submit" className="btn btn-info mt-3 w-100">{buttonText}</Button>

            <br />

            <Link href="/Auth/PasswordRecovery">Password Recovery</Link> <br />
          </BlueBackground>
        </Col>
      </Row>
    </form>
